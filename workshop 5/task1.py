...
def Build_buys_graph(data):
    ...
    plotly.offline.plot([figure],filename="buys_graph.html")
...
if __name__ == '__main__':
    with open(path, "r") as file:
        ...
        Build_graphic_expenses(dataset)
        some_data_2 = Make_products_list(dataset)
        Build_buys_graph(some_data_2)
